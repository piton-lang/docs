---
title: Agent as Compiler
description: Why so much of software development feels repetitive, and what it means to treat an agent as the compiler.
sidebar:
  order: 3
---
...
database, implemented a job queue? Please make it stop. How many times have you
...
a form that pops up in a modal or drawer. Oh wait, that modal needs a curtain.
Please, Make. It. Stop.

We, the collective developer blob, have continually invented, reinvented, and
