---
title: Abstract Anchors
description: Defining the shape of an anchor without values, and the extends type constraint.
sidebar:
  order: 9
---

Abstracts allow us to define the shape of an anchor without providing values.
An abstract anchor alone will never compile; it must be extended by a
non-abstract anchor, and that non-abstract anchor must implement all undefined
abstract properties.
