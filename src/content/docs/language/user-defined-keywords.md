...
description: Syntactic sugar for extends that emphasizes fundamental base anchors.
sidebar:
  order: 10
---

Now with abstracts defined, we can discuss user-defined keywords. This is really
just syntactic sugar equivalent to `extends` that exists to promote clarity of
